      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php if(isset($_SESSION['$guest_msg_done'])): ?>
                    <small class="text-success"><?=$_SESSION['$guest_msg_done'] ?></small>
                    <?php unset($_SESSION['$guest_msg_done']); ?>
                    <?php endif ?>
              <form id="contact" action="admin/guest_message_post.php" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset><?php if(isset($_SESSION['$guest_email_err'])): ?>
                  ...
                  <div class="col-lg-12">
                    ...
                    <?php if(isset($_SESSION['$guest_msg_err'])): ?>
                    <small class="text-danger"><?=$_SESSION['$guest_msg_err'] ?></small>
                    <?php unset($_SESSION['$guest_msg_err']); ?>
                    <?php endif ?>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
